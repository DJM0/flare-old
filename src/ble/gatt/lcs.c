...
static struct bt_uuid_128 uuid_lcs_state = BT_UUID_INIT_128(
...
static struct bt_gatt_attr attrs[] = {
    ...
    BT_GATT_CHARACTERISTIC(&uuid_lcs_state.uuid,
        BT_GATT_CHRC_READ | BT_GATT_CHRC_NOTIFY | BT_GATT_CHRC_WRITE),
    BT_GATT_DESCRIPTOR(&uuid_lcs_state.uuid,
        BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, read_state, write_state, state),
